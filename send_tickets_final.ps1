# Send tickets for paid bookings - Final Version
...
foreach ($booking in $paidBookings) {
    ...
    node .\generate_ticket.js -Template .\ticket_template.pdf -Output $ticketPath -Name $firstName -Surname $lastName -Table $table -Seat $seat -Date "26 October 2025" -Time "18:00" -Place "Asman" -Price "5500 Som" -TicketId $ticketId
